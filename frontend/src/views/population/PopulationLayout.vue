    ...
    <header class="top-bar">
      <div class="top-bar-left">
        <button class="hamburger-btn" @click="toggleSidebar"
                ...
                :aria-expanded="isSidebarOpen" aria-controls="pop-sidebar">
        ...
        <router-link to="/population/dashboard" class="brand-link">
          <div class="brand-icon">
            <svg viewBox="0 0 32 32" fill="none">
              <rect x="2"  y="14" width="6" height="16" rx="1" fill="var(--teal)"/>
              <rect x="10" y="8"  width="6" height="22" rx="1" fill="var(--amber)"/>
              <rect x="18" y="4"  width="6" height="26" rx="1" fill="var(--teal)"  opacity="0.7"/>
              <rect x="26" y="10" width="4" height="20" rx="1" fill="var(--amber)" opacity="0.6"/>
              <line x1="0" y1="30" x2="32" y2="30" stroke="var(--slate-400)" stroke-width="1"/>
            </svg>
          </div>
          <div class="brand-text">
            <span class="brand-name">PopTwin</span>
            <span class="brand-sub">{{ t('brand.popSub') }}</span>
          </div>
        </router-link>
      </div>
      ...
      <nav id="pop-sidebar" class="sidebar" :class="{ collapsed: !isSidebarOpen }" aria-label="Population navigation">
        <div class="sidebar-links">
          ...
          <router-link to="/population/dashboard" class="nav-item"
            :class="{ active: $route.path.startsWith('/population/dashboard') }"
          ...
          <router-link to="/population/registry" class="nav-item"
            :class="{ active: $route.path.startsWith('/population/registry') || $route.path.startsWith('/population-registry') }"
          ...
          <router-link to="/population/2d-map" class="nav-item"
            :class="{ active: $route.path.startsWith('/population/map') || $route.path.startsWith('/population/2d-map') }"
            :title="t('nav.map2d')">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                 stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
          ...
          <router-link to="/population/3d-twin" class="nav-item"
            :class="{ active: $route.path.startsWith('/population/twin') || $route.path.startsWith('/population/3d-twin') }"
            :title="t('nav.twin3d')">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                 stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
[data-theme="light"] .top-bar { box-shadow: 0 1px 8px var(--shadow); }
.top-bar::after {
  content: '';
  position: absolute;
  bottom: 0; left: 0; right: 0; height: 1px;
  background: linear-gradient(90deg,
    transparent 0%, var(--teal-dim) 30%,
    var(--amber-dim) 70%, transparent 100%);
}
...
.lang-current { font-size: 0.72rem; letter-spacing: 0.04em; }
...
.lang-option:hover { background: var(--bg-surface); color: var(--text-body); }
.lang-option.active { color: var(--teal); font-weight: 600; background: var(--teal-dim); }
...
.theme-toggle:hover { background: var(--bg-surface); color: var(--text-body); }
...
.page-leave-active { transition: opacity 0.14s ease-in,  transform 0.14s ease-in; }
